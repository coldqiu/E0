  ...
  export default {
    ...
    methods: {
      select(type, event) {
        ...
        //this.selectType = type; //这个置换放到food.vue 中才不会报错 overwrite

        //this.dispatch('ratingtype.select', event);
      ...
      toggleContent(event) {
        ...
        //this.onlyContent  = !this.onlyContent; //这个置换放到food.vue 中才不会报错 overwrite
